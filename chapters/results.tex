...
\begin{figure}[]
    ...
    \caption{Results of the CP Alfvén Wave test. The particle magnetic field at $t=5$ is projected onto the transverse axis $B2$ and scattered against position along the propagation direction $x_1$. The analytical solution (initial condition) is shown in black. The second panel shows the L1 error $L_1(B_2)$ as a function of resolution $n_x$, which converges with second-order.}
    \label{fig:alfven}
\end{figure}
